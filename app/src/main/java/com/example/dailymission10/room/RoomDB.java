...
public abstract class RoomDB extends RoomDatabase {
    ...
    private static class InitDBTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            roomDao.insert(new Todo("운동"));
            roomDao.insert(new Todo("게임"));
            roomDao.insert(new Todo("산책"));
            roomDao.insert(new Todo("데이트"));
            roomDao.insert(new Todo("큐브"));
            roomDao.insert(new Todo("메이플"));
